import { getAllPensionerService, addPensionerService, updatePensionerService, deletePensionerService } from "./service/PensionerService";
...
// this 
    ...
    return (
        <div className="container">
            ...
            <h1 className="text-ceneter display-4 text-primary mt-3 mb-3" >Pensioner Details Component</h1>
